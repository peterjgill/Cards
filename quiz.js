var questions = [
	...
	[ /*chemistry*//*3*/
		...
		/*84*/"Metal elements appearance is...||shiny",
		/*85*/"Non-metal elements appearance is...||dull",
		/*86*/"Metal elements melting and boiling points are usually...||high",
		/*87*/"Non-metal elements melting and boiling points are usually...||low",
		/*88*/"Metal elements state at room temperature is...||solid",
		/*89*/"Non-metal elements state at room temperature is...||half solid half gas",
		/*90*/"Are metal elements malleable or brittle?||malleable",
		/*91*/"Are non-metal elements malleable or brittle?||brittle",
		/*92*/"Malleable means...||something does not shatter when compressed",
		/*93*/"Ductile means...||something does not shatter when stretched",
		/*94*/"Are metal elements ductile?||yes",
		/*95*/"Are non-metal elements ductile?||no",
		/*96*/"Metal elements conduct...||heat and electricity",
		/*97*/"Non-metal elements conduct...||neither heat nor electricity",
		/*98*/"Metals form ions by...||losing electrons",
		/*99*/"Non-metals form ion by...||gaining electrons",
		/*100*/"When you combine metals...||they can form alloys but do not react",
		/*101*/"When you combine non-metals...||they can react",
		/*102*/"When you combine metals with non-metals...||they can react",
		/*103*/"Metal oxides produce...||alkaline solutions",
		/*104*/"Non-metal oxides produce...||acidic solutions",
		/*105*/"A row of the periodic table is called a...||period",
		/*106*/"A column of the periodic table is called a...||group",
		/*107*/"The electronic structure of lithium (3) is...||2.1",
		/*108*/"Rows of the periodic table have the same number of...||shells",
		/*109*/"Columns of the periodic table have the same number of...||electrons in their outer shell",
		/*110*/"The number of shells is equal to the...||period number",
		/*111*/"The number of electrons in the outer shell is equal to the...||group number",
		/*112*/"An ionic compound is...||a compound made when an electron moves from one atom to another",
		/*113*/"In the solid state, ionic compounds are arranged as...||a giant ionic lattice",
		/*114*/"Ions in a giant ionic lattice are arranged...||in rows and columns",
		/*115*/"Ions in a giant ionic lattice are held together by...||strong electrostatic forces",
		/*116*/"In chemistry, giant means...||something that is reapeated",
		/*117*/"In chemistry, ionic means...||something that is made of ions",
		/*118*/"In chemistry, lattice means...||a regular arrangement",
	],
	[ /*computing*//*4*/
		/*0*/"CPU stands for...",
		/*1*/"ALU stands for...",
		...
		/*54*/"RAM stands for...||Random Access Memory",
		/*55*/"Is RAM volatile?||yes",
		/*56*/"If memory is volatile, it means...||the data will be lost if the computer is turned off",
		/*57*/"RAM has this name because...||a computer can go directly to the location it needs, it does not need to move sequentially to find it",
		/*58*/"RAM stores...||all current programs and data in use",
		/*59*/"RAM is useful because...||it is very fast",
		/*60*/"The hard disk drive is...||a type of magnetic storage device inside a computer for storing data long term",
		/*61*/"ROM stands for...||Read Only Memory",
		/*62*/"Is ROM volatile?||no",
		/*63*/"ROM has this name because...||the computer never writes to it, it only reads from it",
		/*64*/"ROM stores...||the programs and data needed for the computer to boot up",
		/*65*/"ROM is useful because...||the programs and data are needed when the computer is not on yet so other memories will not work",
		/*66*/"Does RAM have more space than ROM?||yes",
		/*67*/"Does a hard disk drive have moving parts?||yes",
		/*68*/"Flash memory is a storage device that does not have...||moving parts",
		/*69*/"Flash memory is described as a...||solid state storage device",
		/*70*/"Advantages of flash memory over a hard disk drive are...||it is more robust, it does not have to warm up, it is often smaller",
		/*71*/"Disadvantages of flash memory are...||it can only be written to and read from a number of times (usually around a million times), it is much more expensive",
		/*72*/"Examples of flash memory include...||USB, SD, SSD",
		/*73*/"Flash memory is written to and erased using...||positive and negative charges",
		/*74*/"Flash memory is made up of...||cells that contain storage transistors that contain logic gates",
		/*75*/"The cache is located...||in the CPU",
		/*76*/"The cache is useful because...||it is the fastest memory",
		/*77*/"Primary storage is...||directly under the control of the CPU",
		/*78*/"Secondary storage is...||not directly under the control of the CPU",
		/*79*/"Data that needs to be stored long term is stored in...||secondary storage",
		/*80*/"The three types of secondary storage are...||optical, magnetic, solid state",
		/*81*/"Optical storage is written to by...||a laser beam in high power mode makes marks on the disk",
		/*81*/"Optical storage is read from by...||a laser beam in low power mode is reflected by the disk to different places depending if there is a mark or not",
		/*82*/"Examples of optical storage include...||CD (700MB), DVD (4.7GB), Blu-ray (50GB)",
		/*83*/"Magnetic storage is written to by...||a read-and-write head can change the polarity of the magnetic regions",
		/*84*/"Magnetic storage is read from by...||a read-and-write head can read the polarity of the magnetic regions",
		/*85*/"An examples of magnetic storage is a...||hard disk drive",
		/*86*/"Advantages of optical storage include...||small, light, cheap, more robust than a hard disk drive, data cannot be overwritten",
		/*87*/"Disadvantages of optical storage include...||relatively small storage space, a special device is often needed to read/write from it, has to warm up",
		/*88*/"Advantages of magnetic storage include...||large storage space, cheap, no limit to how many times you can read/write from it",
		/*89*/"Disadvantages of magnetic storage include...||not very robust, big, has to warm up",
	],
	[ /*music*//*5*/
...
var answers = [
	...
	[ /*geography*//*1*/
		...
		/*70*/"65kph",
		/*71*/"400 years",
		/*72*/"7cm of rain in 2 hours",
		/*73*/"a rising high tide",
		/*74*/"2.15m in 1 hour",
		/*75*/"the remains of Hurricane Alex",
	],
	[ /*english*/
		/*0*/"Poppies",
		/*1*/"Exposure",
