var questions = [
	...
	[ /*geography*//*1*/
		...
		/*87*/"Primary social impacts (cars) of the Boscastle flash flood were...",
		/*88*/"Primary social impacts (properties) of the Boscastle flash flood were...",
		/*89*/"Primary social impacts (people) of the Boscastle flash flood were...",
		/*90*/"Primary economic impacts (tourism) of the Boscastle flash flood were...",
		/*91*/"Primary economic impacts (repairs) of the Boscastle flash flood were...",
		/*92*/"Primary economic impacts (business) of the Boscastle flash flood were...",
	],
	[ /*english*//*2*/
		/*0*/"Exposure",
		/*1*/"Poppies",
	...
	[ /*computing*//*5*/
		...
		/*90*/"In terms of file sizes, an 8-bit image is...||an image with 256 colours to choose from",
		/*91*/"To calculate the file size of an image in bits...||multiply the resolution by the type (8-bit)",
		/*92*/"To turn a number of bits into a number of bytes...||divide by 8",
		/*93*/"To turn a number of bytes into a number of bits...||multiply by 8",
		/*94*/"To turn a number of bytes into a number of kilobytes...||divide by 1024 (or 1000)",
		/*95*/"To turn a number of kilobytes into a number of bytes...||multiply by 1024 (or 1000)",
		/*96*/"The units of data storage are...||bit, nibble, byte, kilobyte, megabye, gigabyte, terabyte, petabyte, exabyte, zettabyte, yottabyte, kilobit, megabit, gigabit, terabit, petabit, exabyte, zettabyte, yottabyte",
		/*97*/"The unit for a bit is...||lowercase b",
		/*98*/"The unit for a nibble is...||nibble",
		/*99*/"The unit for a byte is...||capital B (or lowercase o for octet)",
		/*100*/"The unit for a (x)byte is...||capital (the first letter of x) + capital B",
		/*101*/"The unit for a (x)bit is...||capital (the first letter of x) + lowercase b",
		/*102*/"The units of data storage from kilobyte onwards are...||1024 (or 1000) of the previous unit (or 1024n where K = 1)",
		/*103*/"",
		/*104*/"",
	],
	[ /*music*//*6*/
	...
	[ /*spanish*//*7*/
		...
		/*508*/"popular",
		/*509*/"&#250;til",
		/*510*/"un canal de comunicaci&#243;n",
		/*511*/"una p&#243;rdida de tiempo",
		/*512*/"Estoy / Est&#225; enganchado/a a...",
		/*513*/"Lo &#250;nico malo es que...",
		/*514*/"te engancha",
		/*515*/"actualizando mi p&#225;gina de Facebook",
		/*516*/"editando mis fotos",
		/*517*/"Conjugation of ser:",
		/*518*/"Conjugation of estar:",
		/*519*/"Difference between ser and estar:",
		/*520*/"escuchando m&#250;sica",
		/*521*/"esperando a...",
		/*522*/"descansando",
		/*523*/"pensando en salir",
		/*524*/"preparando algo para merendar",
		/*525*/"repasando para un examen",
		/*526*/"tomando el sol",
		/*527*/"haciendo footing",
		/*528*/"haciendo el vago",
		/*529*/"leyendo",
		/*530*/"viendo una peli",
		/*531*/"escribiendo",
		/*532*/"&#191;Quieres salir conmigo?",
		/*533*/"conmigo",
		/*534*/"No puedo porque...",
	],
];
...
var answers = [
	...
	[ /*geography*//*1*/
		...
		/*70*/"65kph",
		/*71*/"400 years",
		/*72*/"7cm of rain (1422 million litres) in 2 hours",
		...
		/*80*/"the hillsides on either side of boscastle were steep and close together so water travelled quickly to a small area of land making it very deep",
	...
	[ /*english*//*2*/
		...
		/*19*/"Carol Rumens",
		/*20*/"John Agard",
		/*21*/"Slowly melting. I was brave, as I walked",
		/*22*/"hat-less, without a winter coat or reinforcements of scarf, gloves",
		/*23*/"poppies had already been placed on individual war graves.",
		/*24*/"Slowly our ghosts drag home: glimpsing the sunk fires, glozed",
		/*25*/"Tonight, this frost will fasten on this mud and us,",
		/*26*/"The burying-party, picks and shovels in shaking grasp, Pause over half-known faces. All their eyes are ice,",
		/*27*/"But nothing happens. (4)",
		/*28*/"For love of God seems dying.",
		/*29*/"Tonight, this frost will fasten on this mud and us,",
		/*30*/"Wearied we keep awake because the night is silent...",
		/*31*/"in the merciless iced east winds that knive us...",
		/*32*/"But nothing happens. (4)",
	],
	[ /*biology*//*3*/
		/*0*/"Eukaryotic cells",
	...
	[ /*chemistry*//*4*/
		...
		/*136*/"are polymers tangled together, these are easy to separate",
		/*137*/"are polymers cross linked by strong covalent bonds, these are hard to separate",
	...
	[ /*spanish*//*7*/
		...
		/*508*/"popular",
		/*509*/"useful",
		/*510*/"a means of communication",
		/*511*/"a waste of time",
		/*512*/"I am / he/she is hooked on...",
		/*513*/"the only bad thing is that...",
		/*514*/"it gets you hooked",
		/*515*/"updating my Facebook page",
		/*516*/"editing my photos",
		/*517*/"soy, eres, es, somos, sois, son",
		/*518*/"estoy, esta/s, esta/, estamos, esta/is, esta/n",
		/*519*/"ser is permanent estar is temporary",
		/*520*/"listening to music",
		/*521*/"waiting for...",
		/*522*/"relaxing",
		/*523*/"thinking about going out",
		/*524*/"preparing something for snack",
		/*525*/"revising for an exam",
		/*526*/"sunbathing",
		/*527*/"jogging",
		/*528*/"lazing about",
		/*529*/"reading",
		/*530*/"watching a film",
		/*531*/"writing",
		/*532*/"do you want to go out with me?",
		/*533*/"with me",
		/*534*/"I can't because...",
	],
];
