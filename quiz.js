var questions = [
	...
	[ /*geography*//*1*/
		...
		/*172*/"Between July 2010 and January 2011, the number of people living in temporary camps after the Haiti earthquake decreased from...",
	...
	[ /*computing*//*5*/
		...
		/*225*/"The network layer of TCP/IP...||allows the exchange of data between different networks, the IP part of the protocol is used to establish a routeto the destination",
		/*226*/"The data link layer of TCP/IP...||ensures the network hardware and transmission media can be used to transmit the data",
		/*227*/"The physical layer of TCP/IP...||the part of the network that drives the physical transmission of electrical signals across a network, often combined with the data link layer",
		/*228*/"In computing, the cost of a route is determined by...||the length of the path between the computers and their speeds",
		/*229*/"The type of routing that circuit switching uses is called...||static routing",
		/*230*/"The type of routing that packet switching uses is called...||dynamic routing",
		/*231*/"The internet is...||the largest network in the world, a WAN, a network of smaller networks",
		/*232*/"The world wide web is...||the collection of web pages that can be accessed using the internet",
		/*233*/"An IP address is...||a number that uniquely identifies each computer on the internet",
		/*234*/"A domain name is...||the name given to a collection of web pages (e.g. github.com)",
		/*235*/"DNS stands for...||Domain Name Server",
		/*236*/"A DNS...||keeps a directory of all domain names along with their IP address",
		/*237*/"A DNS is usefuls because...||we do not need to remember the IP address of a website",
		/*238*/".com .uk .org .gov indicate...||which top level domain the web page belongs to",
		/*239*/".com is for...||a commercial business (profit)",
		/*240*/".uk is for...||a business based in the UK",
		/*240*/".org is for...||a non profit organisation",
		/*240*/".gov is for...||a government agency",
	],
	[ /*spanish*//*6*/
		/*0*/"Vivo en el",
...
var answers = [
	...
	[ /*biology*//*3*/
		...
		/*229*/"add iodine, if it stays red it does not contain starch, if it turns blue/black it does contain starch",
		/*230*/"peel it, put iodine on the bit you peeled",
		/*231*/"any reducing sugar (fructose or maltose but not sucrose)",
		/*232*/"add benedict's solution and heat, if it stays blue it does not contain glucose, if it turns cloudy orange or brick red it does contain glucose",
		/*233*/"add biuret solution, if it stays blue it does not contain protein, if it turns purple it does contain protein",
		/*234*/"the emulsion test",
		/*235*/"mix the substance with an amount of ethanol, add the same amount of distilled water, if a milky white emulsion forms it does contain lipids",
	],
	[ /*chemistry*//*4*/
	...
	[ /*spanish*//*6*/
		...
		/*1061*/"it’s a good place for spending the afternoon",
